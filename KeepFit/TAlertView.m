...
+ (void)initialize
{
    ...
    appearance.alertBackgroundColor = [UIColor colorWithWhite:0.2 alpha:0.9];
    appearance.titleFont            = [UIFont systemFontOfSize:18];
    appearance.messageColor         = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:1.0f];
...
-(id)showFadeOutAlertWithTitle:(NSString *)title andMessage:(NSString *)message
{
   
    
    TAlertView *alert =  [self initWithTitle:title andMessage:message];
    
    alert.timeToClose = 2.0;
    
    alert.buttonsAlign = TAlertViewButtonsAlignHorizontal;
    alert.style = TAlertViewStyleInformation;
    //alert.backgroundColor = [UIColor colorWithWhite:0.2 alpha:0.9];
